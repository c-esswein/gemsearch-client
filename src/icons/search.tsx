...
export const SearchIcon: React.StatelessComponent<{className?: string}> = ({className = 'svg-inline svg-button-icon svg-fill-current'}) => (
    <svg className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 446.25 446.25">
        <g>
            <g>
