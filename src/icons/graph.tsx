...
export const GraphIcon: React.StatelessComponent<{className?: string}> = ({className = 'svg-inline svg-button-icon svg-fill-current'}) => (
    <svg className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47 47">
        <g>
            <g>
                <g>
